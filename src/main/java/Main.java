...
public class Main {
   ...
   List<File> files;
    public void ver(String args) {
		...
		File file=new File(sCarpAct+File.separator+"src"+File.separator+"main"+File.separator+"java"+File.separator+"com"+File.separator+"."+File.separator+"."+File.separator+".");
