...
//    }
    ...
    public void main() {
        ...
        try {
            ...
            System.out.println(jsonexpected + " expected");
...
//             System.out.println(response.toString() + "resposneeeee");
    ...
    public void tablestest(){
       ...
       String jsonexpected="{\"userApplicationKey\":\"c6j76d7931a0a04bed50\",\"classes\":[{\"name\":"
               + "\"Classes.Foo1\",\"constructor\":[\"Classes.Foo2\"],\"datasources\":"
               ...
               + ",\"hashes\":{\"Foo2\":\"77de5aa206e42de889f28d96392f83fc\"}"
